...
public class GunController : MonoBehaviour
{
    ...
    IEnumerator ShootWithDelay()
    {
        ...
        {
            Vector2 bulletPos = new Vector2(transform.position.x, transform.position.y + bulletOffset);
            BulletController bullet = bulletPool.GetBullet(bulletPos, BulletRotation()).GetComponent<BulletController>();
